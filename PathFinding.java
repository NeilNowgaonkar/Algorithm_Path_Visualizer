...
public class PathFinding
{
    ...
    private void initialize() {	//INITIALIZE THE GUI ELEMENTS
        ...
        algorithmsBx.setBackground(Color.WHITE);
        ...
        toolBx.setBackground(Color.WHITE);
        toolP.add(toolBx);
        space+=buff;
        ...
        obstacles.setBackground(Color.WHITE);
        toolP.add(obstacles);
    ...
    class Algorithm {	//ALGORITHM CLASS
        ...
        //A STAR WORKS ESSENTIALLY THE SAME AS DIJKSTRA CREATINGz A PRIORITY QUE AND PROPAGATING OUTWARDS UNTIL IT FINDS THE END
